...
```
# it is not surpirising that there is quite a bit of overlap between the species occuring in the three counties, as they are physically very close to each other and the wildlife has been generally undistrubed by humans (national parks are well protected/preserved). 
